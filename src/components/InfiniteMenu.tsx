...
void main() {
  ...
  // Simply map UVs directly to preserve original aspect ratio
  vec2 atlasUV = uv * cellSize + cellOffset;
  vec4 color = texture(uTex, atlasUV);
...
class InfiniteGridMenu {
  ...
  private init(onInit?: InitCallback): void {
    ...
    // 4:3 image plane
    this.quadGeo = new QuadGeometry(1.5,2);
    this.discBuffers = this.quadGeo.data;
